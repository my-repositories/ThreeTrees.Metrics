...
namespace ThreeTrees.Tools.Domain
{
        ...
        where TEntity : class
    {
        ...
        /// If entity is not found the <see cref="Exceptions.NotFoundException" /> will be
        /// generated.
        /// </summary>
        /// <param name="keyValues">Entity ids.</param>
        /// <exception cref="Exceptions.NotFoundException">Is generated when entity is not found.</exception>
